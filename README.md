...
- **GET (filtro):** buscar recetas según tipo, sabor, origen, dificultad o si requiere frío.
...
│ ├── GET-FILTRO.png # Ejemplo de consulta filtrada
│ ├── GET-ID.png # Ejemplo de consulta por ID
│ └── GET-RECETAS.png # Ejemplo de listado general
├── middlewares/
│ ├── logger.js # Middleware para logs
│ └── validateData.js # Middleware para validaciones
├── src/
│ ├── controllers/
...
│ │ └── recetas.routes.js
│ └── index.js
├── logs.txt # Registro de peticiones
├── package.json
├── package-lock.json
└── README.md
...
| **GET**    | `/api/recetas/filtro?tipo=pan` | Filtrar combinando query params | `/api/recetas/filtro?apto=celiaco&requiere_frio=no` |
